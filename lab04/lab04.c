...
// Элементы добавлять в очередь(односвязный список)
// Операцию создания и добавления поместить в критическую секцию c семафорами.
// 
...
int main()
{
    ...
    printf("Parallel integral value on [%.3lf, %.3lf] -> %.5lf\n", a, b, integralValue);
